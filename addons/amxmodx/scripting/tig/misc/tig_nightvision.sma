...
public plugin_init()
{
	register_plugin("[TiG] Night Vision", "0.1", "holla");
...
{
	register_library("tig_nightvision");

	register_native("tig_nightvision_set", "native_nightvision_set");
	register_native("tig_nightvision_get", "native_nightvision_get");
	register_native("tig_nightvision_toggle", "native_nightvision_toggle");
}
