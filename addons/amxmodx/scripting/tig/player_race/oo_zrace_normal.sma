...
public plugin_init()
{
	...
	oo_call(menu_o, "AddRace", 
		oo_new("PlayerRace", g_oClassInfo, "ZombieNormal", "平衡"));

	oo_call(g_oClassInfo, "CreateCvars");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_normal", "health", "1500");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_normal", "gravity", "1.0");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_normal", "speed", "1.0");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_normal", "knockback", "1.0");
}
