...
public plugin_init()
{
	...
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_fast", "health", "1500");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_fast", "gravity", "1.0");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_fast", "speed", "1.0");
	oo_call(g_oClassInfo, "CreateCvar", "tig_zombie_fast", "knockback", "1.0");
}
