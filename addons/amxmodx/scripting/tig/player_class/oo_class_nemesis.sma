...
public plugin_init()
{
	...
	bind_pcvar_float(create_cvar("tig_nemesis_rpg_reload_time", "30"), cvar_rocket_reload_time);
	bind_pcvar_float(create_cvar("tig_nemesis_rocket_speed", "1250"), cvar_rocket_speed);
	bind_pcvar_float(create_cvar("tig_nemesis_rpg_radius", "250"), cvar_rocket_radius);
	bind_pcvar_float(create_cvar("tig_nemesis_rocket_min_dmg", "1"), cvar_rocket_mindmg);
	bind_pcvar_float(create_cvar("tig_nemesis_rocket_max_dmg", "150"), cvar_rocket_maxdmg);
	bind_pcvar_float(create_cvar("tig_nemesis_rocket_reload_time", "30"), cvar_rocket_reload_time);

	oo_call(g_oClassInfo, "CreateCvars");
	oo_call(g_oClassInfo, "CreateCvar", "tig_nemesis", "health", "10000");
	oo_call(g_oClassInfo, "CreateCvar", "tig_nemesis", "health2", "1000");
	oo_call(g_oClassInfo, "CreateCvar", "tig_nemesis", "gravity", "0.9");
