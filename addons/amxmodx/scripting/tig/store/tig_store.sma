...
public plugin_init()
{
	register_plugin("[TiG] Store", "0.1", "holla");
	...
	new pcvar = create_cvar("tig_store_ammo_price", "10");
...
public OO_OnPlayerClassSetProps(id) { rg_add_account(id, 99999, AS_SET, true); }
